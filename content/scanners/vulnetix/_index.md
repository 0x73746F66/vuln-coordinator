...
>
> **Rule registry** · 300+ built-in `VNX-*` Rego rules ship in the CLI · Canonical registry of external rule packs: [vulnetix.com/rules-registry](https://www.vulnetix.com/rules-registry) · Load any registered pack via `--rule org/repo` (override the resolution host with `--rule-registry`) · [Vulnetix/community-rules](https://github.com/Vulnetix/community-rules) is one of the registered packs · Built-in rule test cases: [Vulnetix/sast-rule-evals](https://github.com/Vulnetix/sast-rule-evals) (Apache-2.0)
